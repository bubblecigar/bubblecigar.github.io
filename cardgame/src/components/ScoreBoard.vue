<template>
  <div class="wrapper" :class="{hide:gameInfo.gameState==='Playing'}">
    <div class="score-board background-pattern customized-font">
      <p>Congratulation !</p>
      <p>
        You have finished FreeCell in
        <strong>{{ Number(finishingTime.minute)}}</strong> minute(s) and
        <strong>{{ Number(finishingTime.second)}}</strong> seconds
        with
